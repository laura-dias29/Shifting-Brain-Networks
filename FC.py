...
m_cont_rs=np.load("masks/array_t_s_controls_rs.npy")
m_cont_pt=np.load("masks/array_t_s_controls_pt.npy")


# In[3]:


m_rs=np.load("masks/array_t_s_rs.npy")
...
n_m_rs_c=120
list_of_vars_len = [m_rs[0,0,:],m_rs[1,0,:],m_rs[2,0,:],m_rs[3,0,:],m_rs[4,0,:],m_rs[5,0,:],m_rs[6,0,:],m_rs[7,0,:],m_rs[8,0,:],m_rs[9,0,:],m_rs[10,0,:],m_rs[11,0,:],m_rs[12,0,:],m_rs[13,0,:],m_rs[14,0,:],m_rs[15,0,:],m_rs[16,0,:],m_rs[17,0,:],m_rs[18,0,:],m_rs[19,0,:],m_rs[20,0,:],m_rs[21,0,:],m_rs[22,0,:],m_rs[23,0,:],m_rs[24,0,:],m_rs[25,0,:]]
blobs=len(list_of_vars_len)
d=int((np.square(blobs)-blobs)/2)
result=np.zeros([n_m_rs_c,d])
for i in range(n_m_rs_c):
    list_of_vars = [m_rs[0,i,:],m_rs[1,i,:],m_rs[2,i,:],m_rs[3,i,:],m_rs[4,i,:],m_rs[5,i,:],m_rs[6,i,:],m_rs[7,i,:],m_rs[8,i,:],m_rs[9,i,:],m_rs[10,i,:],m_rs[11,i,:],m_rs[12,i,:],m_rs[13,i,:],m_rs[14,i,:],m_rs[15,i,:],m_rs[16,i,:],m_rs[17,i,:],m_rs[18,i,:],m_rs[19,i,:],m_rs[20,i,:],m_rs[21,i,:],m_rs[22,i,:],m_rs[23,i,:],m_rs[24,i,:],m_rs[25,i,:]]
    result_array=np.array([scipy.stats.pearsonr(*pair) for pair in combinations(list_of_vars, 2)])
    result[i]=result_array[:,0]
...
z=np.zeros(np.shape(result))
for i in range(n_m_rs_c):
    for j in range(len(result[0,:])):
        z[i,j]=(0.5*(np.log(1+result[i,j])-np.log(1-result[i,j])))
...
#Resting-State
raw_input_list_rs_t1=np.genfromtxt(r'/home/r085233/paths_rs.txt',dtype=str)

n_rs_t1 = len(raw_input_list_rs_t1)

m_rs_t1=len(raw_input_list_rs_t1)
id_num_rs_t1=np.zeros(m_rs_t1)

for k in range(m_rs_t1):
    id_num_rs_t1[k]=(raw_input_list_rs_t1[k][97:100])

print(len(id_num_rs_t1))


# In[7]:


raw_input_list_rs_hc=np.genfromtxt(r"/home/r085233/concat_paths/paths_concat_input_hc_rs.txt",dtype=str)
...
data_frame_conect=pd.DataFrame(z,columns=['C_1_2','C_1_3','C_1_4','C_1_5','C_1_6','C_1_7','C_1_8','C_1_9','C_1_10','C_1_11','C_1_12','C_1_13','C_1_14','C_1_15','C_1_16','C_1_17','C_1_18','C_1_19','C_1_20','C_1_21','C_1_22','C_1_23','C_1_24','C_1_25','C_1_26','C_2_3','C_2_4','C_2_5','C_2_6','C_2_7','C_2_8','C_2_9','C_2_10','C_2_11','C_2_12','C_2_13','C_2_14','C_2_15','C_2_16','C_2_17','C_2_18','C_2_19','C_2_20','C_2_21','C_2_22','C_2_23','C_2_24','C_2_25','C_2_26','C_3_4','C_3_5','C_3_6','C_3_7','C_3_8','C_3_9','C_3_10','C_3_11','C_3_12','C_3_13','C_3_14','C_3_15','C_3_16','C_3_17','C_3_18','C_3_19','C_3_20','C_3_21','C_3_22','C_3_23','C_3_24','C_3_25','C_3_26','C_4_5','C_4_6','C_4_7','C_4